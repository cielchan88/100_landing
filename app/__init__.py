...
def create_app() -> Flask:
    ...
    from .day26.blueprint import bp as day26_bp
    app.register_blueprint(day26_bp)

    from .day27.blueprint import bp as day27_bp
    app.register_blueprint(day27_bp)

    from .day28.blueprint import bp as day28_bp
    app.register_blueprint(day28_bp)

    from .day29.blueprint import bp as day29_bp
    app.register_blueprint(day29_bp)

    from .day30.blueprint import bp as day30_bp
    app.register_blueprint(day30_bp)

    from .day31.blueprint import bp as day31_bp
    app.register_blueprint(day31_bp)

    from .day32.blueprint import bp as day32_bp
    app.register_blueprint(day32_bp)

    from .day33.blueprint import bp as day33_bp
    app.register_blueprint(day33_bp)

    from .day34.blueprint import bp as day34_bp
    app.register_blueprint(day34_bp)

    from .day35.blueprint import bp as day35_bp
    app.register_blueprint(day35_bp)

    from .day36.blueprint import bp as day36_bp
    app.register_blueprint(day36_bp)

    from .day37.blueprint import bp as day37_bp
    app.register_blueprint(day37_bp)

    from .day38.blueprint import bp as day38_bp
    app.register_blueprint(day38_bp)
